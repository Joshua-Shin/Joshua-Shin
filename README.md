## 안녕하세요! 백엔드 개발에 관심을 갖고 있는 신입 개발자 신중혁 입니다.

C/C++, Java, 자료구조, 알고리즘, 운영체제, 네트워크, 데이터베이스, SQL 등을 공부하였습니다. 

특히 알고리즘 공부를 즐겨하며, 얼마전 백준 저지 사이트에서 Platinum V를 달성하였습니다.

현재는 본격적인 실무 기술을 익히기 위해 Spring을 공부하며 웹 개발을 진행하고 있습니다.
