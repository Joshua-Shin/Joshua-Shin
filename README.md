...
### 💁🏻 About Me
- 2021년까지는 영화 포스트 프로덕션 회사에서 영화음악을 제작하는 작곡가였으나, 1년전 프로그래밍에 깊은 관심이 생겨 개발 공부를 시작하였습니다.
...
- 백엔드 개발에 관심이 있고, Spring과 JPA를 꾸준히 공부하며 학습한 내용을 repository에 기록하고 있습니다.
...
- 실전! **스프링 부트**와 **JPA** 활용1 : 웹 애플리케이션 개발 - 김영한 (수강중) [[실습 프로젝트]](https://github.com/Joshua-Shin/jpashop)
