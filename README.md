...
- 지금은 기업 코딩 테스트를 넘어서 알고리즘 대회에 도전하기 위해 [1 일 1 알고리즘](https://github.com/Joshua-Shin/Algorithm-BaekJoon)을 지속적으로 진행하며 기록하고 있습니다.
- 본격적인 웹 개발 실무 기술을 익히고 포트폴리오를 만들기 위해, Spring과 JPA를 공부하며 [실습 프로젝트](https://github.com/Joshua-Shin/hello-spring)를 기록하고 있습니다.
